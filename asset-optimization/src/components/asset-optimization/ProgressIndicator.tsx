    ...
    <div className={s.optimizingContainer}>
      {isPreview && (
        <div className={s.previewInfoBox}>
          ...
          <p>
            <strong>Preview Mode</strong> - This will calculate potential
            savings without modifying any assets.
          </p>
        </div>
      )}
      {currentAsset && (
        <div className={s.currentAssetPreview}>
          ...
          <div className={s.assetPreviewInfo}>
            ...
            <div className={s.assetPreviewMeta}>
              {currentAsset.path.split('.').pop()?.toUpperCase()} •{' '}
              {(currentAsset.size / (1024 * 1024)).toFixed(2)} MB •{' '}
