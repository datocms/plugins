...
export const DEPLOY_PROVIDER_OPTIONS: DeployProviderOption[] = [
  {
    provider: 'vercel',
    label: 'Vercel',
    url: 'https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fmarcelofinamorvieira%2Fdatocms-backups-scheduled-function&env=DATOCMS_FULLACCESS_API_TOKEN,CRON_SECRET&project-name=datocms-backups-scheduled-function&repo-name=datocms-backups-scheduled-function',
  },
  {
    provider: 'netlify',
    label: 'Netlify',
