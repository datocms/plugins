...
export function MentionBadgeIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M8 0a8 8 0 1 0 8 8 8.009 8.009 0 0 0-8-8Zm0 14.5A6.5 6.5 0 1 1 14.5 8 6.508 6.508 0 0 1 8 14.5Z" />
      <path d="M8 4a3 3 0 0 0-3 3v1a3 3 0 1 0 6 0V7a3 3 0 0 0-3-3Z" />
    </svg>
  );
}
